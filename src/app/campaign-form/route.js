...
const TEMPLATE_PATH = join(process.cwd(), "public", "d3-static", "campaign-form.html");
const ASSET = "/d3-static/JobsForFixedNodeID_files";

/**
 * Campaign Form page — returns the exact D3 "CampaignForm" HTML document
 * directly as the /campaign-form response. The shell is the real D3 export with
...
export async function GET() {
  try {
    ...
    console.error("Error reading campaign-form.html:", error);
